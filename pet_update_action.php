<html>
    <head>
        ...
        <title>/board/board_update.php</title>
    </head>
    <body>
        <h1>/board/board_update_action.php</h1>
        <?php
            // /board/board_update_form.php에서 POST 방식으로 넘어온 값 저장 및 출력
            ...
            $sql = "UPDATE pet SET board_title='".$board_title."',board_content='".$board_content."',board_date=now() WHERE board_no=".$board_no."";
            ...
            mysqli_close($conn);
            //헤더를 이용한 리다이렉션 구현
            header("Location:/board/pet_list.php"); 
        ?>
    </body
</html>