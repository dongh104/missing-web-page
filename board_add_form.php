...
<html>
    ...
    <body class="is-preload">
        ...
        <form class="form-horizontal" action="/board/board_add_action.php" method="post", enctype="multipart/form-data">
            <div class="form-group">
                <label for="exampleInputName1" class="col-sm-2 control-label">실종자명 : </label>
                <div class="col-sm-10">
                    <!-- 작성자명 입력 상자 -->
