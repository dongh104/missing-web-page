...
<html>
    <head>
        ...
        <title>/board/pet_update_form.php</title>
    ...
    <body>
        <h1 class="display-4">/board/board_update.php</h1>
        <?php
            ...
            $sql = "SELECT board_no, board_title, board_content, board_user, board_date FROM pet WHERE board_no = '".$board_no."'";
            $result = mysqli_query($conn,$sql);
            if($row = mysqli_fetch_array($result)){
        ?>
        <br>
        <form action="/board/board_update_action.php" method="post">
