<html>
    ...
    <body>
        ...
        <?php
            ...
            $sql = "INSERT INTO board (board_pw, board_title, board_content, board_user, image_path, board_date) values ('".$board_pw."','".$board_title."','".$board_content."','".$board_user."', '".$board_image."', now())";
            ...
            header("Location: /board/board_list.php"); //헤더 함수를 이용해서 리다이렉션 시킬 수 있다.
        ?>
    </body
</html>
