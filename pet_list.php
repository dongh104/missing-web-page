...
<html>
	...
	<body class="is-preload">
		<!-- Wrapper -->
            ...
            $sqlCount = "SELECT count(*) FROM pet";
            ...
            $sql = "SELECT board_no, board_title, board_user, image_path, board_date FROM pet order by board_no desc limit ".$begin.",".$rowPerPage."";
            ...
            ?>
                <tr>
                    <?php
						...
						echo "<a href='/board/pet_detail.php?board_no=".$row["board_no"]."'>";
        ...
        <?php
            ...
            if($currentPage > 1 ) { 
                ...
                echo "<a class='btn btn-primary' href ='/board/pet_list.php?currentPage=".($currentPage-1)."'>이전</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            }
            ...
            if($currentPage < $lastPage) { 
                ...
                echo "<a class='btn btn-primary' href='/board/pet_list.php?currentPage=".($currentPage+1)."'>다음</a>";
            }
            mysqli_close($conn);
        ?>
        &nbsp;&nbsp;
        <a class="btn btn-primary" href="/board/pet_add_form.php">글 쓰기</a>
						</div>
					</div>
