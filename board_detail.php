...
<html>
	...
	<body class="is-preload">
        ...
        <?php
            ...
            $sql = "SELECT board_no, board_title, board_content, board_user, image_path, board_date FROM board WHERE board_no = '".$board_no."'";
        ...
        <table class="table table-bordered" style="width:100%">
            ...
            <?php
                            echo "<td><a href='/board/board_update_form.php?board_no=".$row["board_no"]."'>수정</a></td>";
                            echo "<td><a href='/board/board_delete_form.php?board_no=".$row["board_no"]."'>삭제</a></td>";
                        ?>
            <?php
                }
            ?>
        ...
        <br>
        &nbsp;&nbsp;&nbsp;
        <a class="btn btn-primary" href="/board/board_list.php"> 리스트로 돌아가기</a>
